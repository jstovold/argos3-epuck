/**
 * @file <argos3/plugins/robots/e-puck/control_interface/ci_epuck_wifi_actuator.h
 *
...
#ifndef CCI_EPUCK_WIFI_ACTUATOR_H
#define CCI_EPUCK_WIFI_ACTUATOR_H

namespace argos {
   class CCI_EPuckWifiActuator;
}
...
namespace argos {
   ...
   class CCI_EPuckWifiActuator : public CCI_Actuator {

   public:

      virtual ~CCI_EPuckWifiActuator() {}
       ...
       */
      virtual void SendMessage(UInt8 un_data) = 0;
