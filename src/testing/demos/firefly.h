#ifndef DEMO_FIREFLY_CONTROLLER_H
#define DEMO_FIREFLY_CONTROLLER_H
...
namespace argos
{
    class CDemoFireflyController : public CCI_Controller
    {
    public:

        CDemoFireflyController();
        virtual ~CDemoFireflyController();
