#ifndef DEMO_DANCE_CONTROLLER_H
#define DEMO_DANCE_CONTROLLER_H
...
namespace argos
{
    class CDemoDanceController : public CCI_Controller
    {
    public:

        CDemoDanceController();
        virtual ~CDemoDanceController();
