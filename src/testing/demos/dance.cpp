...
CDemoDanceController::CDemoDanceController():
        control_step(0),
        left_wheel_speed(1),
        right_wheel_speed(1),
...
void CDemoDanceController::Init(TConfigurationNode& t_node)
{
    // Sensors
...
void CDemoDanceController::ControlStep()
{
    control_step++;
...
REGISTER_CONTROLLER(CDemoDanceController, "demo_dance_controller");
